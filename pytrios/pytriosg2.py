...
def set_integration_time(mod, inttime=0):
    """Set integration time. Saved across restarts."""
    intreg = G2registers().integration_time_cfg
    response = write_single_command(mod['serial'], 1, 6, intreg['start'], inttime, timeout=1.0)
    log.debug(crc_check_incoming(response))
